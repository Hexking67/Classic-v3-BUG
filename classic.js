...
let { key } = await zetsubo.sendMessage(from, {text: '🧞‍♂️𝐁𝐞𝐥𝐭𝐚𝐡-𝐓𝐞𝐜𝐡 𝐏𝐨𝐧𝐠'})
...
break
//=================================================//
case 'menu': case 'help': case 'beltah': {
await loading()
                            ewe = `┏━━━▓ *★●𝐁𝐄𝐋𝐓𝐀𝐇 𝐓𝐄𝐂𝐇●★* ▓━━━━━
┃  ➥𝐒𝐜 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 ❴ 𝐁𝐞𝐥𝐭𝐚𝐡 𝐓𝐞𝐜𝐡 𝟐𝟓𝟒🇰🇪 ❵
┃  ➥ 𝐔𝐬𝐞𝐫 : ${pushname}}
...
image: cewegw, 
  caption: ewe,
  contextInfo:{externalAdReply:{
  title: 'ᚙᚘ ⫹⸙⧉𝐁𝐞𝐥𝐭𝐚𝐡-𝐌𝐃-𝐕3 ⧉⸙⫺   - 𝐊ᚗ𝐈𝐍ᚗ𝐆 ᚘᚙ',
  body: 'ᚙᚘ ⫹⧉⸙LORD BELTAH⸙⧉⸙⫺᚜𝐌𝐈𝐒𝐒𝐈𝐎𝐍᚛ ᚘᚙ', 
  showAdAttribution: true,
  thumbnail:hinachan,
  mediaType: 4,
...
case 'ping': case 'speed': {
  ...
  const pingMsg = await zetsubo.sendMessage(m.chat, { text: '*Pinging*' });
 ...
 await zetsubo.relayMessage(m.chat, {
      protocolMessage: {
        ...
        type: 14,
        editedMessage: {
          conversation: `*Beltah tech pinging➟* *${new Date() - startTime}* 𝐌/𝐒`
        }
      }
    }, {});
  } 
